                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off"
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Profile') }}</h6>
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                    <label class="form-control-label"
                                        for="input-current-password">{{ __('Address') }}</label>
                                    <textarea name="address" class="form-control" id="address" cols="30" rows="10"
                                        placeholder="Current Address...">{{ $userProfile->address }}</textarea>
                                    @if ($errors->has('old_password'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label"
                                        for="input-current-password">{{ __('Photo') }}</label>
                                    @if ($userProfile->photo)
                                        <img src="{{ asset('images/' . $userProfile->photo) }}" alt="User Photo"
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn btn-success mt-4">{{ __('Update Profile') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
